...
class DeviceScanModel extends Model
{
    ...
    protected static array $fillable = [
        'raw_scan_value', 'serienummer', 'product_id', 'beschrijving', 'extra_parts_json', 'device_candidate', 'suggested_asset_type',
        'match_source', 'match_confidence', 'matched_voorraad_item_id', 'matched_schijfgebruik_device_id',
